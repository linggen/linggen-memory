...
| --------------- | -------- | -------------- | ------------------------------------- | ----------------------------------------------- | ------------------ |
| openclaw-plugin | high     | plugin-runtime | before_prompt_build, before_tool_call | definePluginEntry, registerCli, registerCommand | -                  |
...
| --------------- | --------------------------- | ----- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| openclaw-plugin | seam-inventory              | log   | observed 2 hooks, 3 registrations, and 0 manifest contracts                           | hook:before_prompt_build, hook:before_tool_call, registration:definePluginEntry, registration:registerCli, registration:registerCommand | -             |
| openclaw-plugin | package-metadata            | log   | selected package metadata for plugin contract checks                                  | package.json, @linggen/openclaw-plugin, version:0.1.2                                                                                   | -             |
